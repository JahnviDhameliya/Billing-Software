...
?>
    ...
    if($s_date=="" or $e_date==""){
        $sql = "SELECT date,pd_select,ac_name,d_amount,t_amount,pd_select,bill_type,b_amount FROM sales WHERE user_id='$u_id' order by date,ac_name ";
    }
    else if($s_date!="" or $e_date!=""){
        $sql = "SELECT date,pd_select,ac_name,d_amount,t_amount,pd_select,bill_type,b_amount FROM sales WHERE user_id='$u_id' and date BETWEEN '$s_date' and '$e_date' order by date,ac_name ";
    }
...
$ta=$row['t_amount'];
    ...
    <td>$t_c2</td>
    <td>$t_c3</td>
    <td>$t_da</td>    <td>$total</td></tr>";
    
    echo '<form method="POST">';  
    
    echo "<tr><td><a href='print_saleRegister.php? &s_date=".$s_date." &e_date=".$e_date."'>Print</a></td>\n";
    echo "<td><a href='download_saleRegister.php?&s_date=".$s_date." &e_date=".$e_date."'>Download</a></td></tr>\n";
