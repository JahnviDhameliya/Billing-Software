...
$sql5 = "SELECT distinct acname FROM account WHERE user_id='$u_id' and type='purchase'";
...
<form method="POST" action="purchase1.php" name="f1">
...
Account Name:
<input list='name' type='text' name='account_name' class='list' autocomplete="off" style="width:100%;">
<datalist id='name'>
<?php
...
<br><br><br>
    ...
    <table>
        ...
        <tbody id="tbody" onchange='cal();'></tbody>
    </table>
