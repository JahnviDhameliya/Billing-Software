...
<?php
    ...
    if($s_date=="" or $e_date==""){
        ...
        $sql = "SELECT nominee.client_id,nominee.nominee_id,nominee.name,nominee.birth_date,nominee.phone FROM nominee INNER JOIN client  WHERE nominee.phone!=0 and nominee.nid=0 and nominee.client_id=client.client_id and client.policy_id=$p_id and nominee.birth_date BETWEEN '$s_date' and '$e_date'";
