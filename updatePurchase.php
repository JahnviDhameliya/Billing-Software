...
<div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-head-line">Purchase
...
<th>Total Amount</th>
    ...
    for($a=0;$a<count($_POST['quantity']);$a++){
        ...
        $sql="SELECT * FROM purchase WHERE user_id='$user_id' and date='$date' and ac_name='$account_name'  and pd_select='$product' and price='$price' and bill_number='$bill_number'";
        $result=$conn->query($sql); 
        
        
        if ($result->num_rows > 0) {
            $sql2="UPDATE purchase SET pd_select='$product',quantity='$quantity',price='$price',b_amount='$ba',discount='$dis_p',d_amount='$dis_a',t_amount='$ta',bill_type='$bill_type',payment_mode='$pay_mode' WHERE user_id='$user_id' and date='$date' and ac_name='$account_name' and pd_select='$product' and price='$price' and bill_number='$bill_number'";
            mysqli_query($conn, $sql2);
       
        }
        else{
                
        $sql3 = "INSERT INTO purchase (user_id,date,payment_mode,ac_name,bill_type,bill_number,pd_select,quantity,price,discount,d_amount,b_amount,t_amount) VALUES ('$user_id','$date','$pay_mode','$account_name','$bill_type','$bill_number','$product','$quantity','$price','$dis_p','$dis_a','$ba','$ta')";
