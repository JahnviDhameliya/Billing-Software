...
<form action="insertpayout.php" method="post" enctype="multipart/form-data">
    <label>Date:</label>
...
<input list='name' name='p_name' class='list' autocomplete="off" >
<datalist id='name' onselect="c()">
<?php
$s = "SELECT distinct * FROM account where user_id='$name' ";
$r=$conn->query($s)  or die($s);
