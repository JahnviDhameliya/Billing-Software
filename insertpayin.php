...
include 'conith.php';
        ...
        $sql = "INSERT INTO payin (date,payment_mode,reciept_no,party_name,total_amount,discount_amount,remark,user_id,total) VALUES('$date', '$payment_mode', '$reciept_no', '$p_name', '$t_amount', '$d_amount','$remark','$name','$total')";
	...
	if ($conn->query($sql) === true) {
            ...
            <button  value='print'><a href='print_payin.php?reciept_no=".$reciept_no."'>Print</button><br><br> 
            <button  value='download'><a href='download_payin.php?reciept_no=".$reciept_no."'>download</button>";
