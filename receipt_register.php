...
?>
        ...
        <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Receipt Register
                        <button class="btn" align="center" style="background:linear-gradient(120deg,#191970, #900C3F ,#581845);color: white;"> 
                        <a href="reciept.php" class="btn" style="background:linear-gradient(120deg,#191970, #900C3F ,#581845);color: white;">Add Pay Out</a>
                        </button>
...
$u_id=$_SESSION['username'];
    ...
    if($s_date=="" or $e_date==""){
        $sql = "SELECT * FROM payin WHERE user_id='$u_id' order by date ";

    }
    else if($s_date!="" or $e_date!=""){
        $sql = "SELECT * FROM payin WHERE user_id='$u_id' and date BETWEEN '$s_date' and '$e_date' order by date ";
