...
<div id="wrapper">
        ...
        <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Inserted as Income successfully!!</h1>
...
include 'conith.php';
	...
	$sql = "INSERT INTO nominee (nominee_id, client_id, nid, name, birth_date) VALUES('$recipt_no', '$account_name', '$amount', '$remarks', '$date')";
