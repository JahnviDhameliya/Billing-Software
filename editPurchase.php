...
include'conith.php';
        ...
        $sql = "SELECT * from purchase where ac_name='$ac_name' and user_id='$user_id' and date='$date' and bill_number='$bill_number'";
...
$result10=$conn->query($sql10); 
	...
	echo "<div>\n";
	  ...
	  echo '<form method="POST" action="updatePurchase.php" name="f1">';
...
echo "<input type=\"text\" recipt_no=\"fname\" name=\"bill_number\" value=\"$row[bill_number]\">";
echo "<label for=\"fname\">Account Name:</label>&nbsp";
echo "<input type=\"text\" recipt_no=\"fname\" name=\"account_name\" value=\"$row[ac_name]\" style='width:60%'>";
