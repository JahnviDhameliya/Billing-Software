        ...
        <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <a href="sale.php" class="btn" style="background:linear-gradient(120deg,#191970, #900C3F ,#581845);color: white;">Sale</a>
                        </button>
						</h1>
...
$sql = "DELETE FROM sales WHERE pd_select='$pd_select' and user_id='$user_id' and date='$date'";
